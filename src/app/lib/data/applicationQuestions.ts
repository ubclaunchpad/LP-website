import { z } from "zod";
import { FormQuestion } from "../types/questions";
...
const educationQuestions: FormQuestion[] = [
    ...
    },
    {
        ...
        config: {
            isRequired: true,
            schema: z.string().email().refine((email) => email.endsWith("ubc.ca"), {
...
const qualificationQuestions: FormQuestion[] = [
    ...
    {
        type: "checkbox",
        label: "Are you able to attend weekly meetings?",
        id: "meetings",
        placeholder: "Yes",
        config: {
            isRequired: true,
    ...
    {
        type: "checkbox",
        label: "Are you able to attend workshops?",
        id: "workshops",
        placeholder: "Yes",
        config: {
            isRequired: true,
    ...
    {
        type: "checkbox",
        label: "Are you able to attend events?",
        id: "events",
        placeholder: "Yes",
        config: {
            isRequired: true,
