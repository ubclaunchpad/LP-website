...
export default function LandingPage() {
    return (
      <div className="relative bg-customGray min-h-screen flex items-center justify-center">
        ...
        <Image src="/images/planet_2.svg" alt="planet" width={400} height={400}/>
        </div>
        <div className="absolute top-20 right-16">
        <Image src="/images/planet_1.svg" alt="planet" width={500} height={500}/>
        </div>
        ...
        <div className="relative text-white text-left ">
          <h1 className="text-5xl  bg-custom-gradient shadow-sm font-heading font-semibold mb-4">UBC Launch Pad 🪐</h1>
