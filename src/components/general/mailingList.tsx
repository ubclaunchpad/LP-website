...
const text = {
    ...
    description: "Sign up to hear about our upcoming events, announcements, recruitment and tech opportunities!",
...
export default function MailingList() {
    ...
    return (
        <section className="flex flex-col items-center py-10 relative gap-10 text-center bg-[#809CFF] px-20 w-full ">
            <Image src={lpNewsletterImage} alt="Newsletter Image" fill={true}
            ...
            <form className="flex h-[49px] justify-center w-full gap-4 items-center z-40 " method={"post"} action={NEWSLETTER_URI}>
                <Input
                    name={"email"}
                    type="email"
                    id="bd-email"
