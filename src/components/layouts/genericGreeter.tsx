...
export default function GenericGreeter({
  ...
  return (
    <React.Fragment>
      <div className="w-screen h-screen max-w-screen max-h-screen  overflow-hidden fixed flex justify-center items-center">
        {useBg && (
      ...
      {includeStyle ? (
        ...
        <div
          className={
            "z-40  w-full flex-1 flex flex-col justify-center lg:p-10 py-10 bg-background-900 bg-opacity-80"
          }
        >
          <div
            className={
